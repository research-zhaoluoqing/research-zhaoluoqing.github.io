...
thumb: /assets/img/stale-not-wrong.webp
---

<figure>
  <img src="/assets/img/stale-not-wrong.webp" width="1200" height="669" loading="lazy" decoding="async"
       alt="Recovering the right version: a three-layer fix for long workflows that ship stale decisions. Panel one shows step 3 setting a definition, step 9 overruling it, and step 11 still outputting step 3. Panels two to four cover writing a ruling rather than a list, append-only storage where compaction is a view rather than a deletion, and orchestration that selects for recall.">
  <figcaption>The three layers, and the failure they exist to prevent. Constraints measured on five models, nineteen conditions and eighteen adversarial cases.</figcaption>
</figure>
