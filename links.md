...
title: Links
permalink: /links/
description: Where to find the code, the papers, the identifiers and the feed.
---
...
<ul class="cards">
  ...
  <li class="reveal">
    <a href="https://github.com/research-zhaoluoqing">
      ...
      <span class="what">Code, protocols and reproduction scripts for the papers.</span>
  ...
  <li class="reveal">
    <a href="{{ site.linkedin }}">
      ...
      <span class="what">Professional profile.</span>
  ...
  <li class="reveal">
    <a href="mailto:{{ site.email }}">
      ...
      <span class="what">Research correspondence.</span>
